...
public class SmartGuideView extends LinearLayout implements IEditorListener2, IRendererListener, View.OnClickListener
{
  ...
  protected void onAttachedToWindow()
  {
    ...
    TextView moreView = (TextView) findViewById(R.id.more_view);
  ...
  private void update(ContentBlock block, final UpdateCause cause)
  {
    if (block != null && block.getType().equals("Text"))
    {
      ...
      try
      {
        styleView = (TextView) findViewById(R.id.style_view);
      ...
      post(new Runnable()
      {
        ...
        public void run()
        {
          ...
          if (updateWords)
          {
            final LinearLayout stackView = (LinearLayout) findViewById(R.id.stack_view);
  ...
  {
    TextView styleView = (TextView) findViewById(R.id.style_view);
