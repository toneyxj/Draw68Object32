...
public class ErrorActivity extends Activity
{
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState)
  {
    ...
    findViewById(R.id.show_title).setOnClickListener(new View.OnClickListener() {
      @Override
  ...
  public static void start(Context context, String message, String details)
  {
  ...
  {
    Thread.setDefaultUncaughtExceptionHandler(new ExceptionHandler(context.getApplicationContext()));
  }
